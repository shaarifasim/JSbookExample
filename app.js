...
// var x = prompt ("what is the correct ans?");
// var score = 0;
...
// ch16
// var pets = ["dog","cat", "fish","lion"];
// pets.pop(0);
// alert(pets);
// pets.push("dog","elephant");
// alert(pets);
...
// var cleanestCities = ["Cheyenne", "cheyenne", "Santa Fe", "santa fe", "Tucson", "tucson","greatfalls", "Honolulu", "honolulu"];
...
function expandLoris() {
     ...
     make up the genus Nycticebus. They have a round head, narrow snout, large eyes, and a variety 
     distinctive coloration patterns that are species-dependent. The hands and feet  slow lorises have several
     adaptations that give them a pincer-like grip and enable them to grasp branches for long periods  time.
